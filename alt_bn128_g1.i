...
%extend G1<libff::alt_bn128_pp> {
  Fqt G1<libff::alt_bn128_pp>::getx() { return $self->X; }
  Fqt G1<libff::alt_bn128_pp>::gety() { return $self->Y; }
  Fqt G1<libff::alt_bn128_pp>::getz() { return $self->Z; }
};    
